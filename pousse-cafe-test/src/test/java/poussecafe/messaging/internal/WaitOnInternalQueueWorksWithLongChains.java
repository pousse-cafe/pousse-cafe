...
import poussecafe.test.domain.chain1.Chain1Bundle;
import poussecafe.test.domain.chain1.Chain1Element;
import poussecafe.test.domain.chain1.Chain1ElementFactory;
import poussecafe.test.domain.chain1.Chain1ElementRepository;
import poussecafe.test.domain.chain1.ChainElementTouchable;
import poussecafe.test.domain.chain2.Chain2Bundle;
import poussecafe.test.domain.chain2.Chain2Element;
import poussecafe.test.domain.chain2.Chain2ElementFactory;
import poussecafe.test.domain.chain2.Chain2ElementRepository;
import poussecafe.test.domain.chain3.Chain3Bundle;
import poussecafe.test.domain.chain3.Chain3Element;
import poussecafe.test.domain.chain3.Chain3ElementFactory;
import poussecafe.test.domain.chain3.Chain3ElementRepository;
