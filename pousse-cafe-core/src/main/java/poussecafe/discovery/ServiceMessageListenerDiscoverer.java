...
public class ServiceMessageListenerDiscoverer {
    ...
    public List<poussecafe.messaging.MessageListener> discoverListeners() {
        List<poussecafe.messaging.MessageListener> listeners = new ArrayList<>();
        for (Method method : service.getClass().getMethods()) {
            poussecafe.messaging.MessageListener listener = tryDiscoverListener(method);
            if (listener != null) {
    ...
    private poussecafe.messaging.MessageListener tryDiscoverListener(Method method) {
